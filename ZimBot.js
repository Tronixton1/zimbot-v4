// ⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈⧈
//▮BOT_NYAMA 2022 2022 ®️ALL RIGHTS RESERVED
//▮
...
const reply = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "ZIM BOT V4",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, detectLinks: true,body: "TRADER_NYAMA", thumbnail: fs.readFileSync(''),sourceUrl: ("https://youtu.be/Invxa1tg6wc")}}})
}
const replay = (teks) => {
    ZimBotInc.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: "ZIM BOT V4",mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: "TRADER_NYAMA", thumbnail: fs.readFileSync(''),sourceUrl: ("https://youtu.be/Invxa1tg6wc")}}})
}
...
setTimeout(function(){
  ZimBotInc.sendMessage(ZimBotInc.user.id, {text: `*BOT_NYAMA 2022 ANNOUNCEMENT:* *WHATSAPP GROUP TO DRIPS OFC*\n\n*YOUTUBE:* https://chat.whatsapp.com/HD3XnQeB7WKEN5UCrHqKwc\n\n*NEW FEATURES COMING SOON SO STAY TUNED*\n\n*FEEL FREE TO BRING IDEAS OF THE FEATURES ON THE TABLE*\n\n*IF YOU WANT TO CONTRUBUTE FORK THE REPO, MAKE CHANGES PUSH YOUR CHANGES TO THE ORIGIN BRANCH AND WAIT FOR YOUR PULL REQUEST TO BE VERIFIED*\n\n*Thanks for choosing zim-bot*`,contextInfo: { externalAdReply:{title:"ZIM BOT V4",body:"WHATSAPP GROUP DRIPS OFC",showAdAttribution: true,mediaType:2,thumbnail: fs.readFileSync(``) ,mediaUrl:`https://youtu.be/3oXYQVeeN94`, sourceUrl: `https://youtu.be/3oXYQVeeN94` }}}, {quoted: m})
 ...
 */
 ...
 case 'sc': case 'script': case 'donate': case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
  ...
  teks = `
  *BOT NYAMA V2*\n\n*YOUTUBE:* https://youtu.be/Invxa1tg6wc\n*DERIV:* https://record.binary.com/_Mxrjb7udl0q6tyDIijdDK2Nd7ZgqdRLk/1/\n\n*DONATE BITCOIN:*\n 37S8GAHWoF3TE4mv6sNkXxLnZs7wC2eCZW`
  let buttons = [
  ...
  sourceUrl: "https://youtu.be/Invxa1tg6wcg"
  }}
  }
  ZimBotInc.sendMessage(m.chat, buttonMessage, { quoted: m })
  }
...
if (!regex1.test(args[0])) throw 'link!'
   let [, user, repo] = args[0].match(regex1) || []
    ...
    ZimBotInc.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' , quoted: m,contextInfo: { externalAdReply:{
      ...
      mediaUrl:`https://youtu.be/3oXYQVeeN94`, 
      sourceUrl: `https://youtu.be/3oXYQVeeN94`,
      }}
      })
 ...
 case 'truth':
        ...
        thumbnail: fs.readFileSync(``) ,
        mediaUrl:`https://youtu.be/Invxa1tg6wc`, 
        sourceUrl: `https://youtu.be/Invxa1tg6wc` }}}, {quoted: m})
break
case 'ghsearch': 
       case 'githubsearch': 
       case 'searchgithub':
...
ZimBotInc.sendMessage(m.chat, { document : { url : baby1[0].link}, fileName : baby1[0].nama, mimetype: baby1[0].mime ,  quoted : mudratunha, contextInfo: { externalAdReply:{
  title:"ZIM BOT V4",
  body:"WHATSAPP GROUP DRIPS OFC",
  showAdAttribution: true,
  mediaType:2,
  thumbnail: fs.readFileSync(``) ,
  mediaUrl:`https://youtu.be/RzEDjlkdkNQ`, 
sourceUrl: `https://youtu.be/RzEDjlkdkNQ` }}}, {quoted: m})
}
break
case 'song': {
  reply(mess.wait)
...
{ buttonId: 'stop', buttonText: { displayText: 'STOP' }, type: 1 }
  ...
  await ZimBotInc.sendButtonText(m.chat, buttons, `_You Are Still In Anonymous Session, BOT_NYAMA 2022 To Terminate Your Anonymous Session_`, ZimBotInc.user.name, m)
  throw false
   }
 ...
 *ᴜᴘᴛɪᴍᴇ :* ${runtime(process.uptime())}
 ...
 └───────────●
        `,
         buttonText: "SET MENU",
         footerText: "BOT_NYAMA 2022 ",
         listType: "SINGLE_SELECT",
         sections: [{
       "title": "BOT_NYAMA 2022",
       "rows": [
       {
...
CREATE A TRADING ACCOUNT USING THE LINK BELOW 
...
%readmore` 
    ...
    const buttonsDefault = [{ urlButton: { displayText: `WHATSAPP GROUP`, url : `https://chat.whatsapp.com/HD3XnQeB7WKEN5UCrHqKwc` } }, { urlButton: { displayText: `GITHUB`, url : `https://record.binary.com/_Mxrjb7udl0q6tyDIijdDK2Nd7ZgqdRLk/1/` } },
    {					
      quickReplyButton: {
      displayText: 'SPEED',
      id: 'ping'
    ...
    contextInfo: { externalAdReply:{
      ...
      thumbnail: fs.readFileSync(``) ,
      mediaUrl:`https://youtu.be/RzEDjlkdkNQ`, 
    sourceUrl: `https://youtu.be/RzEDjlkdkNQ`
    }}}, {quoted:m})
